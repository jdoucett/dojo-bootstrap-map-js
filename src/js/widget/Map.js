define([
    ...
    return declare([_WidgetBase, _TemplatedMixin], {
        ...
        _initMap: function() {
            ...
            var soilDynamicLayer = new ArcGISDynamicMapServiceLayer("http://prodgis2.agriculture.purdue.edu/arcgis/rest/services/IISGLakeMI/Decade_Catch_Data_LakeMI/MapServer", {
                "opacity": .90,
                imageParameters: imageParameters
            });
            this.map.addLayer(soilDynamicLayer);
        },
